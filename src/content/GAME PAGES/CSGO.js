...
export default function Games() {
    const slides =[
        { image: "../GAMES/COUNTER-STRIKE GLOBAL OFFENSIVE/CSGO1.jpg"},
        { image: "../GAMES/COUNTER-STRIKE GLOBAL OFFENSIVE/CSGO2.jpg"},
        { image: "../GAMES/COUNTER-STRIKE GLOBAL OFFENSIVE/CSGO3.jpg"},
        { image: "../GAMES/COUNTER-STRIKE GLOBAL OFFENSIVE/CSGO4.jpg"},
        { image: "../GAMES/COUNTER-STRIKE GLOBAL OFFENSIVE/CSGO5.jpg"}
    ];
